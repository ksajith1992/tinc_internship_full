...
<Card className='card_product'>
  ...
  <Card.Body>
    <Card.Title className='black'>Technology </Card.Title>
...
<div className="bg_yellow">
  <div className="row p-2 ">
    <div className="col-sm-6 bg_yellow_center"><Button variant="warning" className=''> <FontAwesomeIcon icon={faRupeeSign} /> 5000</Button></div>
...
<Card className='card_product'>
  ...
  <Card.Body>
    <Card.Title className='black'>Advenced Technology  </Card.Title>
    <Card.Subtitle className="mb-2 text-muted">4598 Enrollments</Card.Subtitle>
    <Card.Text className='black mg_top'>
      Some quick example text to build on the card title and make up the bulk of
      the card's content.
    </Card.Text>
...
<Card className=''>
  ...
  <Card.Body>
    <Card.Title className='black'>Internship for Technology </Card.Title>
    <Card.Subtitle className="mb-2 text-muted">245 Enrollments</Card.Subtitle>
    <Card.Text className='black mg_top'>
      Some quick example text to build on the card title and make up the bulk of
      the card's content.
    </Card.Text>
