...
function Cancelationpolicy() {
  return (
    ...
    <div id='backgroundfooter'>
      <Navbarinn />
      <div className="row" > 
          <h3 style={{textAlign:'center',color:'black',marginTop:10}}>Return, Refund and Cancellation policy</h3> 
          <p style={{paddingLeft:40,paddingRight:40}}>Your use of this website constitutes your acceptance to the terms of this Return-Refund.</p>
